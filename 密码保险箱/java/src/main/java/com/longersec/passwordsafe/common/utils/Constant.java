...
public class Constant {
    ...
    /**注册的手机号*/
    public static final String PHONE_CODE_REGISTER = "phone-code-register_";

    /**手机号发送验证码临时缓存*/
    public static final String PHONE_CODE_SEND = "phone-code-send_";

    /**算术验证码临时缓存*/
    public static Integer VERTIFY_CODE = null;
    ...
    /**用户名称 key*/
    public static final String JWT_USER_PHONE="jwt-user-phone-key";
    ...
    /**正常token*/
    public static final String ACCESS_TOKEN="wxytoken";
    ...
    /**用户权鉴缓存 key*/
    public static final String IDENTIFY_CACHE_KEY="shiro-cache:com.pet.other.shiro.CustomRealm.authorizationCache:";
