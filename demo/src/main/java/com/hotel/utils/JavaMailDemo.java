...
public class JavaMailDemo {
    ...
    public static String sendEmailAccount = "2357191256@qq.com";
    public static String sendEmailPwd = "kuecawllcfoediga";
    public static String receiveMailAccount = "850981492@qq.com";
/*    //网易
public static String sendEmailSMTPHost = "smtp.163.com";
    public static String sendEmailAccount = "wxy18955007261@163.com";
    public static String sendEmailPwd = "KZJTTKBHWSDCJXPU";
    public static String receiveMailAccount = "wyj669666@163.com";*/
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setRecipient(MimeMessage.RecipientType.BCC, new InternetAddress(sendMail, "XX用户", "UTF-8"));
        // 4. Subject: 邮件主题（标题有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改标题）--尽量别用英文
        message.setSubject("想我没", "UTF-8");
