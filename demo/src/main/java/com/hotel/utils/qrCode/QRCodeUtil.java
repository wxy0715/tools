...
public class QRCodeUtil {
	...
	public void encoderQRCode(String content,String imgPath,String imgType,int size)  throws Exception{
		...
		/**
		 * @Description "src/二维码.png" --> 二维码.png
		 **/
	...
	public  BufferedImage qRcodeCommon(String content ,String imgType,int size)  throws Exception{
		...
		//BufferedImage：内存中的图片 //red green blue
		...
		Image logo =  ImageIO.read(new File("D:/我的文档/Pictures/Saved Pictures/xcx-4.jpg")  ) ;
	...
	public String decoderQRCode(String imgPath) throws Exception{
		...
		com.hotel.utils.qrCode.TwoDimensionCodeImage tdcImage = new com.hotel.utils.qrCode.TwoDimensionCodeImage(bufImg);
